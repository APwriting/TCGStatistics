...
mana_curve_examples_csv_export = "Data/002_Example_mana_curve_types/002_Example_Distributions_Mana_Curve_Types_2026.xlsx";
...
Complete_Plot = plot_grid(plotlist = Curve_plots,nrow = 2);
Complete_Plot;
#Save Plot

plot_name = paste("Chapter_5_1_2__Mana_curve_types_plot__", Sys.Date()  ,".png")
